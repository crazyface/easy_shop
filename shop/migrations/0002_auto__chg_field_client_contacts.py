...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Client.contacts'
        db.alter_column('shop_client', 'contacts', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Client.contacts'
        db.alter_column('shop_client', 'contacts', self.gf('django.db.models.fields.TextField')(default=1))
